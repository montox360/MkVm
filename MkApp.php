...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script src="js/correos_ajax.js"></script>
    ...
    <body>
        ...
        <div class="container">
        <form action="./MkApp.php" method="POST" role="form">
        	<legend>RENEWALS MAILER - EXTERIOR</legend>
...
<?php
        if(isset($_POST['reporte'])&& $_POST['reporte']==1)
        {
            ...
            renovaciones_onscreen($_POST['Idioma']);
            echo "</div>";
