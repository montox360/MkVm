...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container">
        <form action="./MkConcedidas.php" method="POST" role="form">
...
<?php
        ...
        {            
            ...
            concedidas_onscreen($conexion, $_POST['Idioma'], $_POST['boletin']);
            echo "</div>";
...
?>
    <script src="js/concedidas_ajax.js"></script>
    </body>
    </html>