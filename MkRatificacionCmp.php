...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>MK Ratificacion!</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">  
        <script src="js/ratificaciones_ajax.js"></script>
    ...
    <body>
        ...
        <div class="container">
        <form action="./MkRatificacionCmp.php" method="POST" role="form">
        	<legend>Ratificaciones - EXTERIOR</legend>
...
<?php
        if(isset($_POST['reporte'])&& $_POST['reporte']==1)
        {
            ...
            ratificaciones_onscreen($conexion, $_POST['Idioma']);
            echo "</div>";
